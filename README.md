...
```
app/src/main/java/com/java-parson-nine/HelloController.java
```
...
**Important:** Replace the image placeholder `gcr.io/YOUR_PROJECT_ID/java-parson-nine:latest` with your actual GCR or Artifact Registry path.
